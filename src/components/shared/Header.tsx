...
const Header: React.FC = () => {
  ...
  const projectName = "Code Cart";
  const projectDescription = "An E-Commerce Innovation";
  ...
  return (
    <>
        ...
        >
          ...
          <div className="hidden md:block flex-1">
            <img
              ...
              className="inline-block h-10 md:h-16 scale-90 duration-300 hover:scale-100 transition-transform duration-300 ease-in-out"
            />
          </div>
      ...
      {/* Shopping Cart Panel */}
      {isCartVisible && (
        <div className="fixed top-24 right-6 w-80 h-2/3 bg-white shadow-lg z-50">
